...
# -*- coding: utf-8 -*-
"""
Datasets for dual-seg latent vertex heatmap training and testing.

These dataset classes extend the latent vertex heatmap setup by adding a
parcel-mask branch alongside the original mask branch.
"""
...
class LatentVertexHeatmapDualSegTrainDataset(Dataset):
    """Training dataset for the dual-seg latent heatmap setup."""
...
class LatentVertexHeatmapDualSegTestDataset(Dataset):
    """Test dataset for the dual-seg latent heatmap setup."""
