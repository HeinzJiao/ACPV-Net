...
Example:
    python tools/polygonize_pslg_one_image.py \
        ...
        --out_json /path/to/polygons.json \
        --vss --dp_fix
"""
...
def main():
    ...
    if args.vis_dir:
        ...
        # Use a consistent style: black edges, highlighted vertices, and the
        # category palette for fills.
        EDGE_COLOR = (0, 0, 0)
        POINT_COLOR = (0, 128, 255)

        # Draw each instance by filling first, carving holes safely, and then
        # overlaying edges and vertices.
