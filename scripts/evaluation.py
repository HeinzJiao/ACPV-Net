...
if __name__ == "__main__":
    ...
    # ------------------------- FFL (OTP) -------------------------
    python3 evaluation.py \
    --gt-file ./ACPV-Net/data/deventer_512/test/annotations/road.json \
    --dt-file "../work3/FFL-main/data/mapping_challenge_dataset(Deventer_512)/eval_runs_summary/road.json" \
    --eval-type ciou
    ...
    python3 evaluation.py \
        --gt-file ./ACPV-Net/data/deventer_512/test/annotations/road.json \
        --dt-file ../work3/HiSup-main/outputs/deventer_512_summary/road.json \
        --eval-type ciou
