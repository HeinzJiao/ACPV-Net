...
if __name__ == "__main__":
    ...
    python eval_betti_errors.py \
        --dt_file path/to/prediction.json \
        --gt_file path/to/ground_truth.json \
    """

    """
    # ----- Ours gb_v5_dp-2.5_angle_tol-10_corner_eps-2_replace_thresh-5 -----
    python3 eval_betti_errors.py \
    --gt_file ./ACPV-Net/data/deventer_512/legacy/poly_gt_global_boundary/test/d-2_angle_tol_deg-10-5-2_corner_eps-2_min_sep-3_len_px-10-6_v5/categories_coco_ann/road_bridge.json \
    --dt_file ./ACPV-Net/outputs/legacy/deventer_vmamba-small_512_vh_m_ldm_v1.5_simp_gt_b8/ddim/poly_gb_v5_dp-2.5_angle_tol-10_corner_eps-2_replace_thresh-5_nms-3_th-0.5_topk-1k/categories/road_bridge.json
    
    # Ablation: OPC enabled, VSS disabled (PSLG + DP)
    python3 calculate_betti_errors_coco.py \
    --gt ./HiSup-main/data/deventer_512/poly_gt_global_boundary/test/d-2_angle_tol_deg-10-5-2_corner_eps-2_min_sep-3_len_px-10-6_v5/categories_coco_ann/water.json \
    --pred ./HiSup-main/outputs/deventer_vmamba-small_512_vh_m_ldm_v1.5_simp_gt_b8/ddim/aba_topo_recon/no_vss_dp-3/categories/water.json
    
    # whu building
    python3 calculate_betti_errors_coco.py \
        --gt ./HiSup-main/data/WHU_Building/annotation/test_512.json \
        --pred ./HiSup-main/outputs/whu_building_vmamba-small_512_vh_m_ldm_v1.5/ddim/poly_global_boundary_v3_nms-3_th-0.5_topk-1k/categories/building.json
    
    # ---- DeepSnake -----
    python3 calculate_betti_errors_coco.py \
    --gt ./HiSup-main/data/deventer_512/poly_gt_global_boundary/test/d-2_angle_tol_deg-10-5-2_corner_eps-2_min_sep-3_len_px-10-6_v5/categories_coco_ann/water.json \
    --pred ./PS_cluster_baseline_results/dance-master/output/deventer_512/dsnake_R50_bs8_ep100/categories_preds_poly/water.json
    
    python3 calculate_betti_errors_coco.py \
    --gt ./HiSup-main/data/WHU_Building/annotation/test_512.json \
    --pred ./PS_cluster_baseline_results/dance-master/output/whu_building/dsnake_R50_bs8_ep100/dsnake_whu_outer_holes.json  # WHU_Building
    
    # ----- FFL -----
    python3 calculate_betti_errors_coco.py \
    --gt ./HiSup-main/data/deventer_512/poly_gt_global_boundary/test/d-2_angle_tol_deg-10-5-2_corner_eps-2_min_sep-3_len_px-10-6_v5/categories_coco_ann/water.json \
    --pred "../work3/FFL-main/data/mapping_challenge_dataset(Deventer_512)/eval_runs_summary/water.json"
    
    # whu building
    python3 calculate_betti_errors_coco.py \
    --gt ./HiSup-main/data/WHU_Building/annotation/test_512.json \
    --pred "../work3/FFL-main/data/mapping_challenge_dataset(whu_building)/eval_runs/mapping_dataset.unet_resnet101_pretrained_2025-10-03_14_22_54/test.annotation.poly.acm.tol_1.json" 
    
    # ----- TopDiG -----
    python3 calculate_betti_errors_coco.py \
    --gt ./HiSup-main/data/deventer_512/poly_gt_global_boundary/test/d-2_angle_tol_deg-10-5-2_corner_eps-2_min_sep-3_len_px-10-6_v5/categories_coco_ann/water.json \
    --pred ./PS_cluster_baseline_results/TopDiG/records/Deventer_512_summary/water.json
    
    # whu building
    python3 calculate_betti_errors_coco.py \
    --gt ./HiSup-main/data/WHU_Building/annotation/test_512.json \
    --pred ./PS_cluster_baseline_results/TopDiG/records/WHU_Building_TCND_300pt/coco_predictions.json
    
    # ----- HiSup -----
    python3 calculate_betti_errors_coco.py \
    --gt ./HiSup-main/data/deventer_512/poly_gt_global_boundary/test/d-2_angle_tol_deg-10-5-2_corner_eps-2_min_sep-3_len_px-10-6_v5/categories_coco_ann/water.json \
    --pred ../work3/HiSup-main/outputs/deventer_512_categories/water.json
    
    # whu building
    python3 calculate_betti_errors_coco.py \
        --gt ./HiSup-main/data/WHU_Building/annotation/test_512.json \
        --pred ../work3/HiSup-main/outputs/whu_building_512_hrnet48/25e/predictions.json 
    
    # ----- GCP -----
    python3 calculate_betti_errors_coco.py \
    --gt ./HiSup-main/data/deventer_512/poly_gt_global_boundary/test/d-2_angle_tol_deg-10-5-2_corner_eps-2_min_sep-3_len_px-10-6_v5/categories_coco_ann/water.json \
    --pred ./PS_cluster_baseline_results/GCP/work_dirs/summary_deventer_512/water.json
    
    # whu building
    python3 calculate_betti_errors_coco.py \
        --gt ./HiSup-main/data/WHU_Building/annotation/test_512.json \
        --pred ./PS_cluster_baseline_results/GCP/work_dirs/summary_whu_building/coco_preds.segm.poly.json
    """
